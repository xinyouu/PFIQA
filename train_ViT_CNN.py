...
from model.deform_regressor_ViT_CNN_0111 import Pixel_Prediction
...
class Train:
    ...
    def train_epoch(self, epoch):
        ...
        for data in tqdm(self.train_loader):
            ...
            cnn_ref_1 = torch.nn.functional.interpolate(get_single_resnet_feature(self.save_output,0), size=(28, 28), mode='bilinear', align_corners=False) #256
            cnn_ref_2 = get_single_resnet_feature(self.save_output,3)                                                                      #512
            cnn_ref_3 = torch.nn.functional.interpolate(get_single_resnet_feature(self.save_output,7), size=(28, 28), mode='bilinear', align_corners=False) #1024
            cnn_ref_4 = torch.nn.functional.interpolate(get_single_resnet_feature(self.save_output,13), size=(28, 28), mode='bilinear', align_corners=False)#2048
            ...
            for data in tqdm(self.val_loader):
                ...
                for i in range(self.opt.num_avg_val):
                    ...
                    cnn_ref_1 = torch.nn.functional.interpolate(get_single_resnet_feature(self.save_output, 0), size=(28, 28),
                                              mode='bilinear', align_corners=False).repeat(4, 1, 1,1)  # 256
                    cnn_ref_2 = get_single_resnet_feature(self.save_output, 3).repeat(4, 1, 1,1)  # 512
                    cnn_ref_3 = torch.nn.functional.interpolate(get_single_resnet_feature(self.save_output, 7), size=(28, 28),
                                              mode='bilinear', align_corners=False).repeat(4, 1, 1,1)  # 1024
                    cnn_ref_4 = torch.nn.functional.interpolate(get_single_resnet_feature(self.save_output, 13), size=(28, 28),
                                              mode='bilinear', align_corners=False).repeat(4, 1, 1,1)  # 2048
