...
class BaseOptions():
    ...
    def initialize(self):
        # dataset path
        self._parser.add_argument('--train_ref_path', type=str, default='/dataset/RealSRQ/LR/', help='path to reference images')
        self._parser.add_argument('--train_dis_path', type=str, default='/dataset/RealSRQ/SR/', help='path to distortion images')
        self._parser.add_argument('--val_ref_path', type=str, default='/dataset/RealSRQ/LR/', help='path to reference images')
        self._parser.add_argument('--val_dis_path', type=str, default='/dataset/RealSRQ/SR/', help='path to distortion images')
        self._parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help=' models are saved here')
        self._parser.add_argument('--train_list', type=str, default='datasets/RealsrQ/train.txt', help='training data')
        self._parser.add_argument('--val_list', type=str, default='datasets/RealsrQ/test.txt', help='testing data')
        self._parser.add_argument('--name', type=str, default='RealSRQ_PFIQA',
        ...
        self._parser.add_argument('--num_crop', type=int, default=1, help='ran`dom crop times')
        self._parser.add_argument('--num_avg_val', type=int, default=5, help='ensemble ways of validation')
        
        self._parser.add_argument('--gpu_ids', type=str, default='2', help='gpu ids')
